...
function(e) {
	...
	a = n(77),
	u = o(a),
	l = n(70); (0, l.addLoadEvent)(function() {
		u.
	default.init(),
		i.
	default.init()
...
function(e, t, n) {
	...
	l = function(e, t, n) {
		...
		x = d ? o: m ? o[t] : (o[t] || {})[u];
		d && (n = t);
		for (s in n) c = !p && x && void 0 !== x[s],
		c && s in g || (f = c ? x[s] : n[s], g[s] = d && "function" != typeof x[s] ? n[s] : v && c ? i(f, o) : y && x[s] == f ?
		function(e) {
...
function(e, t, n) {
	...
	e.exports = function(e, t, n, g, w, x, b) {
		...
		if (A && (I = f(A.call(new e)), I !== Object.prototype && (c(I, E, !0), o || u(I, p) || a(I, p, y))), _ && k && k.name !== v && (O = !0, D = function() {
			return k.call(this)
		}), o && !b || !d && !O && R[p] || a(R, p, D), l[t] = D, l[E] = y, w) if (C = {
			values: _ ? D: T(v),
			keys: x ? D: T(h),
			entries: M
		},
		b) for (S in C) S in R || i(R, S, C[S]);
...
function(e, t, n) {
	...
	function(e, t) {
		var n;
		return null !== e ? (u[l] = o(e), n = new u, u[l] = null, n[a] = e) : n = s(),
		void 0 === t ? n: r(n, t)
	}
},
function(e, t, n) {
...
function(e, t, n) {
	...
	G = function(e, t, n) {
		...
		t = b(t, !0),
		w(n),
		r(Z, t) ? (n.enumerable ? (r(e, P) && e[P][t] && (e[P][t] = !1), n = S(n, {
			enumerable: C(0, !1)
		})) : (r(e, P) || R(e, P, C(1, {})), e[P][t] = !0), W(e, t, n)) : R(e, t, n)
	},
	Y = function(e, t) {
		w(e);
	...
	function() {
		return this._k
	}), T.f = $, E.f = G, n(33).f = I.f = Q, n(19).f = X, n(34).f = ee, i && !n(18) && u(z, "propertyIsEnumerable", X, !0), m.f = function(e) {
		return J(d(e))
	}),
	a(a.G + a.W + a.F * !B, {
		Symbol: D
...
function(e, t, n) {
	...
	function i() {
		...
		t = document.querySelector(".mask"); (0, s.
	default)(e, "in"),
		(0, s.
	default)(e, "ready"),
		(0, s.
	...
	var o = function(e) {
			...
			if (i(e)) {
				...
				for (var l in e) {
					...
					if (!a(s)) {
						...
						u.push(l + ":" + s),
						n.push(l + "=" + encodeURIComponent(s)),
						r.push(l + "[" + t + "]=" + encodeURIComponent(s))
					}
				}
			}
		...
		y = e.BJ_REPORT = {
			...
			init: function(e) {
				...
				return r && (/qq\.com$/gi.test(location.hostname) && (o.url || (o.url = "//badjs2.qq.com/badjs"), o.uin || (o.uin = parseInt((document.cookie.match(/\buin=\D+(\d+)/) || [])[1], 10))), o.report = (o.url || "/badjs") + "?id=" + r + "&uin=" + o.uin + "&from=" + encodeURIComponent(location.href) + "&"),
				t.length && v(),
				y
			},
				...
				if ("undefined" != typeof document) {
					...
					for (var l = document.cookie ? document.cookie.split("; ") : [], s = /(%[0-9A-Z]{2})+/g, c = 0; c < l.length; c++) {
						...
						try {
							...
							if (p = n.read ? n.read(p, d) : n(p, d) || p.replace(s, decodeURIComponent), this.json) try {
								p = JSON.parse(p)
							} catch(e) {}
							if (t === d) {
								a = p;
	...
	function() {
		...
		var e = function(e, t) {
			...
			E = function(e) {
				...
				i = r.getAttribute("class") || "", a = 0; a < K.length; a++) n = K[a],
			...
			W = function() {
				var e, n, r, i = function(o) {
					...
					a = 0; a < i; a++) {
						e = o[a],
						n = e.className;
						for (var u = 0; u < K.length; u++) r = K[u],
			...
			b.update = function() {
				S && e.currItem ? (b.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, r), O(r, "caption--empty", !e.currItem.title)), C = !0) : C = !1,
				I || D(),
				R()
			},
			...
			b.getFullscreenAPI = function() {
				...
				t && (t.enter = function() {
					return s = v.closeOnScroll,
					v.closeOnScroll = !1,
					"webkitRequestFullscreen" !== this.enterK ? e.template[this.enterK]() : void e.template[this.enterK](Element.ALLOW_KEYBOARD_INPUT)
				},
				t.exit = function() {
					return v.closeOnScroll = s,
					document[this.exitK]()
				},
	...
	* Copyright (c) 2015 Dmitry Semenov; */
	...
	function() {
		...
		var e = function(e, t, n, o) {
			...
			De = function(e, t, n, o, r) { (!Se || r && r !== i.currItem) && (o /= r ? r.fitRatio: i.currItem.fitRatio),
				e[k] = x + t + "px, " + n + "px" + b + " scale(" + o + ")"
			},
			Me = function(e) {
				oe && (e && (g > i.currItem.fitRatio ? Se || (pn(i.currItem, !1, !0), Se = !0) : Se && (pn(i.currItem), Se = !1)), De(oe, me.x, me.y, g))
			},
			Ae = function(e) {
			...
			Pe = function(e, t) {
				if (!l.loop && t) {
					...
					o = Math.round(e - gt.x); (n < 0 && o > 0 || n >= Qt() - 1 && o < 0) && (e = gt.x + o * l.mainScrollEndFriction)
				}
				gt.x = e,
				Fe(e, d)
			},
			...
			Ze = null,
			Ue = function() {
				Ze && (r.unbind(document, "mousemove", Ue), r.addClass(e, "pswp--has_mouse"), l.mouseUsed = !0, Oe("mouseUsed")),
			...
			ze = function() {
				...
				l.mouseUsed || r.bind(document, "mousemove", Ue),
				r.bind(window, "resize scroll", i),
				Oe("bindEvents")
			},
			Be = function() {
				r.unbind(window, "resize", i),
				r.unbind(window, "scroll", y.scroll),
				r.unbind(document, "keydown", i),
				r.unbind(document, "mousemove", Ue),
				Z.transform && r.unbind(i.scrollWrap, "click", i),
				J && r.unbind(window, h, i),
				Oe("unbindEvents")
			},
			qe = function(e, t) {
			...
			Ye = function(e) {
				e && (Y || G || re || K) && (e.preventDefault(), e.stopPropagation())
			},
			Ve = function() {
			...
			$e = 0,
			Qe = function(e) {
				Xe[e] && (Xe[e].raf && F(Xe[e].raf), $e--, delete Xe[e])
			},
			et = function(e) {
				Xe[e] && Qe(e),
				Xe[e] || ($e++, Xe[e] = {})
			...
			ot = {
				...
				init: function() {
					if (!s && !c) {
						...
						l.modal && (xe ? e.style.position = "fixed": (e.style.position = "absolute", e.style.top = r.getScrollY() + "px")),
						void 0 === N && (Oe("initialLayout"), N = L = r.getScrollY());
						var f = "pswp--open ";
						...
						i.updateCurrItem(),
						Oe("afterInit"),
						xe || (C = setInterval(function() {
							$e || J || Q || g !== i.currItem.initialZoomLevel || i.updateSize()
						},
						1e3)),
				...
				close: function() {
					s && (s = !1, c = !0, Oe("close"), Be(), tn(i.currItem, null, !0, i.destroy))
				},
				destroy: function() {
					Oe("destroy"),
					Gt && clearTimeout(Gt),
				...
				panTo: function(e, t, n) {
					n || (e > ne.min.x ? e = ne.min.x: e < ne.max.x && (e = ne.max.x), t > ne.min.y ? t = ne.min.y: t < ne.max.y && (t = ne.max.y)),
					me.x = e,
					me.y = t,
					Me()
				},
				...
				updateSize: function(t) {
					...
					if (he.x = i.scrollWrap.clientWidth, he.y = i.scrollWrap.clientHeight, Ve(), ge.x = he.x + Math.round(he.x * l.spacing), ge.y = he.y, Pe(ge.x * ve), Oe("beforeResize"), void 0 !== m) {
						for (var o, a, s, c = 0; c < u; c++) o = I[c],
						Fe((c + m) * ge.x, o.el.style),
						s = p + c - 1,
						l.loop && Qt() > 2 && (s = Te(s)),
						a = $t(s),
						a && (S || a.needsUpdate || !a.bounds) ? (i.cleanSlide(a), i.setContent(o, s), 1 === c && (i.currItem = a, i.updateCurrZoomItem(!0)), a.needsUpdate = !1) : o.index === -1 && s >= 0 && i.setContent(o, s),
						a && a.container && (ln(a, he), pn(a), Ae(a));
						S = !1
					}
					w = g = i.currItem.initialZoomLevel,
					ne = i.currItem.bounds,
					ne && (me.x = ne.center.x, me.y = ne.center.y, Me(!0)),
					Oe("resize")
				},
				zoomTo: function(e, t, n, o, i) {
					t && (w = g, wt.x = Math.abs(t.x) - me.x, wt.y = Math.abs(t.y) - me.y, je(de, me));
					var a = qe(e, !1),
					u = {};
					Je("x", a, u, e),
					Je("y", a, u, e);
					...
					Ne(u);
					var c = function(t) {
						1 === t ? (g = e, me.x = u.x, me.y = u.y) : (g = (e - l) * t + l, me.x = (u.x - s.x) * t + s.x, me.y = (u.y - s.y) * t + s.y),
						i && i(t),
						Me(1 === t)
					};
			...
			Ot = {},
			Rt = function(e, t) {
				return Ot.prevent = !_t(e.target, l.isClickableElement),
				Oe("preventDragEvent", e, t, Ot),
				Ot.prevent
			},
			kt = function(e, t) {
				return t.x = e.pageX,
			...
			jt = function(e) {
				...
				return D ? (ce = 0, ft.forEach(function(e) {
					...
					ce++
				})) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Lt[0] = kt(e.touches[0], Ft), e.touches.length > 1 && (Lt[1] = kt(e.touches[1], Pt))) : (Ft.x = e.pageX, Ft.y = e.pageY, Ft.id = "", Lt[0] = Ft),
				Lt
			},
			Nt = function(e, t) {
				var n, o, r, a, u = 0,
				...
				f = gt.x + t.x,
				p = gt.x - pt.x;
				return n = s > ne.min[e] || s < ne.max[e] ? l.panEndFriction: 1,
				s = me[e] + t[e] * n,
			...
			Zt = function(e) {
				if (! ("mousedown" === e.type && e.button > 0)) {
					...
					if (!W || "mousedown" !== e.type) {
						...
						$ = null,
						tt(),
						J && 1 !== o || (J = ae = !0, r.bind(window, h, i), q = se = ue = K = X = Y = H = G = !1, ie = null, Oe("firstTouchStart", n), je(de, me), pe.x = pe.y = 0, je(st, n[0]), je(ct, st), pt.x = ge.x * ve, dt = [{
							x: st.x,
							y: st.y
						}], z = U = Re(), qe(g, !0), It(), Tt()),
						!Q && o > 1 && !re && !X && (w = g, G = !1, Q = H = !0, pe.y = pe.x = 0, je(de, me), je(at, n[0]), je(ut, n[1]), Dt(at, ut, xt), wt.x = Math.abs(xt.x) - me.x, wt.y = Math.abs(xt.y) - me.y, ee = te = St(at, ut))
					}
				}
			},
			Ut = function(e) {
			...
			zt = function() {
				if ($) {
					var e = $.length;
					if (0 !== e) if (je(at, $[0]), lt.x = at.x - st.x, lt.y = at.y - st.y, Q && e > 1) {
						if (st.x = at.x, st.y = at.y, !lt.x && !lt.y && bt($[1], ut)) return;
						je(ut, $[1]),
						G || (G = !0, Oe("zoomGestureStarted"));
						var t = St(at, ut),
						n = Jt(t);
						...
						if ("v" === ie && l.closeOnVerticalDrag && !Et()) {
							pe.y += lt.y,
							me.y += lt.y;
							var c = At();
							return K = !0,
			...
			Bt = function(e) {
				...
				Oe("pointerUp"),
				Rt(e, !1) && e.preventDefault();
				var t;
				if (D) {
					var n = r.arraySearch(ft, e.pointerId, "id");
					if (n > -1) if (t = ft.splice(n, 1)[0], navigator.pointerEnabled) t.type = e.pointerType || "mouse";
					else {
						var o = {
							4 : "mouse",
							2 : "touch",
				...
				var a, u = jt(e),
				s = u.length;
				if ("mouseup" === e.type && (s = 0), 2 === s) return $ = null,
				!0;
				1 === s && je(ct, u[0]),
				0 !== s || ie || re || (t || ("mouseup" === e.type ? t = {
					x: e.pageX,
					y: e.pageY,
					type: "mouse"
				...
				var c = -1;
				if (0 === s && (J = !1, r.unbind(window, h, i), It(), Q ? c = 0 : yt !== -1 && (c = Re() - yt)), yt = 1 === s ? Re() : -1, a = c !== -1 && c < 150 ? "zoom": "swipe", Q && s < 2 && (Q = !1, 1 === s && (a = "zoomPointerUp"), Oe("zoomGestureEnded")), $ = null, Y || G || re || K) if (tt(), B || (B = qt()), B.calculateSwipeSpeed("x"), K) {
					var f = At();
					if (f < l.verticalDragRange) i.close();
					else {
						var p = me.y,
						d = le;
						nt("verticalDrag", 0, 1, 300, r.easing.cubic.out,
						function(e) {
							me.y = (i.currItem.initialPosition.y - p) * e + p,
							ke((1 - d) * e + d),
							Me()
						}),
						Oe("onVerticalDrag", 1)
			...
			qt = function() {
				var e, t, n = {
					...
					calculateSwipeSpeed: function(o) {
						dt.length > 1 ? (e = Re() - z + 50, t = dt[dt.length - 2][o]) : (e = Re() - U, t = ct[o]),
					...
					calculateOverBoundsAnimOffset: function(e, t) {
						n.backAnimStarted[e] || (me[e] > ne.min[e] ? n.backAnimDestination[e] = ne.min[e] : me[e] < ne.max[e] && (n.backAnimDestination[e] = ne.max[e]), void 0 !== n.backAnimDestination[e] && (n.slowDownRatio[e] = .7, n.slowDownRatioReverse[e] = 1 - n.slowDownRatio[e], n.speedDecelerationRatioAbs[e] < .05 && (n.lastFlickSpeed[e] = 0, n.backAnimStarted[e] = !0, nt("bounceZoomPan" + e, me[e], n.backAnimDestination[e], t || 300, r.easing.sine.out,
						function(t) {
							me[e] = t,
							Me()
						}))))
					...
					panAnimLoop: function() {
						if (Xe.zoomPan && (Xe.zoomPan.raf = A(n.panAnimLoop), n.now = Re(), n.timeDiff = n.now - n.lastNow, n.lastNow = n.now, n.calculateAnimOffset("x"), n.calculateAnimOffset("y"), Me(), n.calculateOverBoundsAnimOffset("x"), n.calculateOverBoundsAnimOffset("y"), n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05)) return me.x = Math.round(me.x),
			...
			Kt = function(e) {
				...
				e.backAnimStarted = {},
				Math.abs(e.lastFlickSpeed.x) <= .05 && Math.abs(e.lastFlickSpeed.y) <= .05 ? (e.speedDecelerationRatioAbs.x = e.speedDecelerationRatioAbs.y = 0, e.calculateOverBoundsAnimOffset("x"), e.calculateOverBoundsAnimOffset("y"), !0) : (et("zoomPan"), e.lastNow = Re(), void e.panAnimLoop())
			},
			Wt = function(e, t) {
				var n;
				re || (ht = p);
				...
				var c, f = ge.x * ve,
				d = Math.abs(f - gt.x);
				return n || f > gt.x == t.lastFlickSpeed.x > 0 ? (c = Math.abs(t.lastFlickSpeed.x) > 0 ? d / Math.abs(t.lastFlickSpeed.x) : 333, c = Math.min(c, 400), c = Math.max(c, 250)) : c = 333,
				ht === p && (n = !1),
				re = !0,
				Oe("mainScrollAnimStart"),
				nt("mainScroll", gt.x, f, c, r.easing.cubic.out, Pe,
				function() {
					tt(),
					re = !1,
					ht = -1,
					(n || ht !== p) && i.updateCurrItem(),
			...
			Ht = function() {
				...
				var o, a = 1,
				u = le;
				return ue && !q && !se && g < t ? (i.close(), !0) : (ue && (o = function(e) {
					ke((a - u) * e + u)
			...
			var Gt, Yt, Vt, Xt, $t, Qt, en, tn = function(t, n, o, a) {
				Gt && clearTimeout(Gt),
				Xt = !0,
				Vt = !0;
				var u;
				...
				c = function() {
					Qe("initialZoom"),
					o ? (i.template.removeAttribute("style"), i.bg.removeAttribute("style")) : (ke(1), n && (n.style.display = "block"), r.addClass(e, "pswp--animated-in"), Oe("initialZoom" + (o ? "OutEnd": "InEnd"))),
					a && a(),
					Xt = !1
				};
				if (!s || !u || void 0 === u.x) return Oe("initialZoom" + (o ? "Out": "In")),
				...
				var d = function() {
					...
					o || (g = u.w / t.w, me.x = u.x, me.y = u.y - L, i[a ? "template": "bg"].style.opacity = .001, Me()),
					et("initialZoom"),
					...
					Gt = setTimeout(function() {
						if (Oe("initialZoom" + (o ? "Out": "In")), o) {
							...
							p = le,
							d = function(t) {
								1 === t ? (g = i, me.x = u.x, me.y = u.y - N) : (g = (i - f) * t + f, me.x = (u.x - l.x) * t + l.x, me.y = (u.y - N - l.y) * t + l.y),
								Me(),
								a ? e.style.opacity = 1 - t: ke(p - t * p)
							};
							n ? nt("initialZoom", 0, 1, s, r.easing.cubic.out, d, c) : (d(1), Gt = setTimeout(c, s + 20))
						} else g = t.initialZoomLevel,
						je(me, t.initialPosition),
						Me(),
						ke(1),
						a ? e.style.opacity = 1 : ke(1),
						Gt = setTimeout(c, s + 20)
					},
					o ? 25 : 90)
				};
				d()
			...
			un = function(e, t, n) {
				...
				o.max.y = n > nn.y ? Math.round(nn.y - n) + e.vGap.top: o.center.y,
			...
			sn = function(e, t, n, o, r, a) {
				t.loadError || o && (t.imageAppended = !0, pn(t, o, t === i.currItem && Se), n.appendChild(o), a && setTimeout(function() {
			...
			dn = function() {
				if (on.length) {
					for (var e, t = 0; t < on.length; t++) e = on[t],
			...
			Ie("Controller", {
				publicMethods: {
					lazyLoadItem: function(e) {
						e = Te(e);
						var t = $t(e);
						t && (!t.loaded && !t.loading || S) && (Oe("gettingData", e, t), t.src && cn(t))
					},
					initController: function() {
						...
						_e("mainScrollAnimComplete", dn),
						_e("initialZoomInEnd", dn),
						_e("destroy",
						function() {
							for (var e, t = 0; t < Yt.length; t++) e = Yt[t],
					...
					setContent: function(e, t) {
						...
						if (!a.src && a.html && (a.html.tagName ? u.appendChild(a.html) : u.innerHTML = a.html), fn(a), ln(a, he), !a.src || a.loadError || a.loaded) a.src && !a.loadError && (o = r.createEl("pswp__img", "img"), o.style.opacity = 1, o.src = a.src, pn(a, o), sn(t, a, u, o, !0));
							...
							if (a.loadComplete = function(n) {
								if (s) {
									if (e && e.index === t) {
										if (fn(n, !0)) return n.loadComplete = n.img = null,
										ln(n, he),
										Ae(n),
										void(e.index === p && i.updateCurrZoomItem());
										n.imageAppended ? !Xt && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : Z.transform && (re || Xt) ? on.push({
											item: n,
											baseDiv: u,
											img: n.img,
											index: t,
											holder: e,
											clearPlaceholder: !0
										}) : sn(t, n, u, n.img, re || Xt, !0)
									}
									n.loadComplete = null,
									n.img = null,
									Oe("imageLoadComplete", t, n)
								}
							},
							...
							a.loading || cn(a),
							i.allowProgressiveImg() && (!Vt && Z.transform ? on.push({
								item: a,
								baseDiv: u,
								img: a.img,
								index: t,
						...
						Vt || t !== p ? Ae(a) : (oe = u.style, tn(a, o || a.img)),
						e.el.innerHTML = "",
						e.el.appendChild(u)
					},
			...
			Ie("Tap", {
				publicMethods: {
					initTap: function() {
						_e("firstTouchStart", i.onTapStart),
						_e("touchRelease", i.onTapRelease),
						_e("destroy",
						function() {
							hn = {},
							mn = null
			...
			Ie("DesktopZoom", {
				publicMethods: {
					...
					setupDesktopZoom: function(t) {
						...
						_e("unbindEvents",
						function() {
							yn && r.unbind(e, n, i.handleMouseWheel)
						}),
						i.mouseZoomedIn = !1;
						var o, a = function() {
					...
					handleMouseWheel: function(e) {
						if (g <= i.currItem.fitRatio) return l.modal && (!l.closeOnScroll || $e || J ? e.preventDefault() : k && Math.abs(e.deltaY) > 2 && (f = !0, i.close())),
						!0;
						if (e.stopPropagation(), yn.x = 0, "deltaX" in e) 1 === e.deltaMode ? (yn.x = 18 * e.deltaX, yn.y = 18 * e.deltaY) : (yn.x = e.deltaX, yn.y = e.deltaY);
						else if ("wheelDelta" in e) e.wheelDeltaX && (yn.x = -.16 * e.wheelDeltaX),
						...
						qe(g, !0);
						var t = me.x - yn.x,
						n = me.y - yn.y; (l.modal || t <= ne.min.x && t >= ne.max.x && n <= ne.min.y && n >= ne.max.y) && e.preventDefault(),
						i.panTo(t, n)
					},
			...
			var gn, wn, xn, bn, Cn, Sn, In, Tn, En, _n, On, Rn, kn = {
				history: !0,
				galleryUID: 1
			},
			Dn = function() {
			...
			An = function() {
				...
				if (l.galleryPIDs) {
					var i = t.pid;
					for (t.pid = 0, n = 0; n < Yt.length; n++) if (Yt[n].pid === i) {
						t.pid = n;
						break
					}
			...
			Fn = function() {
				...
				Rn ? "#" + n !== window.location.hash && history[Tn ? "replaceState": "pushState"]("", document.title, o) : Tn ? On.replace(o) : On.hash = n,
				Tn = !0,
			...
			Ie("History", {
				publicMethods: {
					initHistory: function() {
						if (r.extend(l, kn, !0), l.history) {
							On = window.location,
							_n = !1,
							En = !1,
							Tn = !1,
							In = Dn(),
							Rn = "pushState" in history,
							In.indexOf("gid=") > -1 && (In = In.split("&gid=")[0], In = In.split("?gid=")[0]),
							_e("afterChange", i.updateURL),
							_e("unbindEvents",
							function() {
							...
							var e = function() {
								Sn = !0,
								En || (_n ? history.back() : In ? On.hash = In: Rn ? history.pushState("", document.title, On.pathname + On.search) : On.hash = ""),
								Mn()
							};
							_e("unbindEvents",
							function() {
							...
							t > -1 && (In = In.substring(0, t), "&" === In.slice( - 1) && (In = In.slice(0, -1))),
							setTimeout(function() {
					...
					onHashChange: function() {
						return Dn() === In ? (En = !0, void i.close()) : void(bn || (Cn = !0, i.goTo(An().pid), Cn = !1))
					},
					updateURL: function() {
						Mn(),
						Cn || (Tn ? gn = setTimeout(Fn, 800) : Fn())
					}
				}
			}),
			r.extend(i, ot)
